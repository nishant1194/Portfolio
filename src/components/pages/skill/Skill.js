            ...
            <ul className="aboutItemse">
              ...
              <li className="aboutIteme">
                <div className="aboutItemTexte">
                  <h3 className="ttilee">
                    Coordinator | Aeromodelling Club, IITRopar
                  </h3>
                  <p className="disccpe">
                    Core member of Aeromodelling club of IIT Ropar. Made
                    quadcopter and RC plane as a team project in group and
                    conducted sessions for juniors.{" "}
                  </p>
                </div>
              </li>
              ...
              <li className="aboutIteme">
                <div className="aboutItemTexte">
                  ...
                  <p className="disccpe">
                    Student representative in the Utility Feedback Management
                    Committee, presenting the crucial feedback of students to
                    the college administration. Collaboratively working to
                    improve and enhance utility services for a better student
                    experience.
                  </p>
                </div>
              </li>
              <li className="aboutIteme">
                <div className="aboutItemTexte">
                  ...
                  <p className="disccpe">
                    Successfully conducted Skymaster, a drone racing event, as
                    part of Advitiya, the technical fest of IIT Ropar.
                  </p>
                </div>
              </li>
            </ul>
